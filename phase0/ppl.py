...
def main():
    ...
    ap.add_argument("--down-requant", action="store_true",
                    help="M3 residency: requantize down_proj along H (bundle representation); "
                         "measures the added quant error vs clean sparsity")
    ...
    sim = LlamaSim(model_dir, cfg, threads=args.threads, down_requant=args.down_requant)
